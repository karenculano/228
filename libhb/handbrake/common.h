...
#define HB_VCODEC_FFMPEG_VAAPI_H264 0x08000000
#define HB_VCODEC_FFMPEG_VAAPI_H265 0x10000000
#define HB_VCODEC_FFMPEG_VAAPI_VP8 0x20000000
#define HB_VCODEC_FFMPEG_VAAPI_VP9 0x40000000
#define HB_VCODEC_FFMPEG_MASK  (0x00000F0|HB_VCODEC_FFMPEG_VCE_H264|HB_VCODEC_FFMPEG_VCE_H265|HB_VCODEC_FFMPEG_NVENC_H264|HB_VCODEC_FFMPEG_NVENC_H265|HB_VCODEC_FFMPEG_VT_H264|HB_VCODEC_FFMPEG_VT_H265|HB_VCODEC_FFMPEG_VT_H265_10BIT|HB_VCODEC_FFMPEG_MF_H264|HB_VCODEC_FFMPEG_MF_H265|HB_VCODEC_FFMPEG_VAAPI_H264|HB_VCODEC_FFMPEG_VAAPI_H265|HB_VCODEC_FFMPEG_VAAPI_VP8|HB_VCODEC_FFMPEG_VAAPI_VP9)
...
#define HB_VCODEC_H264_MASK    (HB_VCODEC_X264_MASK|HB_VCODEC_QSV_H264|HB_VCODEC_FFMPEG_VCE_H264|HB_VCODEC_FFMPEG_NVENC_H264|HB_VCODEC_FFMPEG_VT_H264|HB_VCODEC_FFMPEG_MF_H264|HB_VCODEC_FFMPEG_VAAPI_H264)
...
#define HB_VCODEC_H265_MASK    (HB_VCODEC_X265_MASK|HB_VCODEC_QSV_H265_MASK|HB_VCODEC_FFMPEG_VCE_H265|HB_VCODEC_FFMPEG_NVENC_H265|HB_VCODEC_FFMPEG_VT_H265|HB_VCODEC_FFMPEG_VT_H265_10BIT|HB_VCODEC_FFMPEG_MF_H265|HB_VCODEC_FFMPEG_VAAPI_H265)

#define HB_VCODEC_FFMPEG_VAAPI_MASK    0x78000000
#define HB_VCODEC_IS_VAAPI(a)        ( 0 != ( a & HB_VCODEC_FFMPEG_VAAPI_MASK ) )
